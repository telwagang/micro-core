...
namespace Microcore.Migrations
{
    ...
    [Migration("20180102033729_BaseTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Micro_core.Models.Akiba", b =>
                {
                    b.Property<string>("AkibaId");
            ...
            modelBuilder.Entity("Micro_core.Models.akiba.StartAkiba", b =>
                {
                    b.Property<string>("StartAkibaId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("StartAkibaId");

                    b.HasIndex("CustomerId");

                    b.HasIndex("StaffId");

                    b.ToTable("StartAkiba");
                });

            modelBuilder.Entity("Micro_core.Models.AkibaCT", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Micro_core.Models.AkibaDT", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Micro_core.Models.Loan.Loan", b =>
                {
                    ...
                    b.Property<DateTime>("datesumbit");
            ...
            modelBuilder.Entity("Micro_core.Models.Akiba", b =>
                {
                    b.HasOne("Micro_core.Models.akiba.StartAkiba", "StartAkiba")
                        .WithOne("Akiba")
                        .HasForeignKey("Micro_core.Models.Akiba", "AkibaId")
            ...
            modelBuilder.Entity("Micro_core.Models.AkibaCT", b =>
                {
                    b.HasOne("Micro_core.Models.Akiba", "Akiba")
                        .WithMany("AkibaCT")
                        .HasForeignKey("AkibaId");
